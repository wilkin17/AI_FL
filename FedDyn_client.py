...
class FLClient(fl.client.NumPyClient):
    def __init__(self, client_data):
        ...
        self.train_dataset = TimeSeriesDataset(
            client_data, self.sequence_length, self.prediction_length
        )
    ...
    def set_parameters(self, parameters):
        ...
        state_dict = {
            k: torch.tensor(np.copy(v), dtype=torch.float32) for k, v in params_dict
        }
...
if __name__ == "__main__":
    ...
    save_averaged_device_losses("feddyn_averaged_device_losses.csv")
